...
/* USER CODE BEGIN 0 */
uint8_t uart7_dma_rx_buffer[UART7_RX_SIZE];
uint8_t uart7_dma_tx_buffer[UART7_RX_SIZE];

uint8_t uart8_dma_rx_buffer[UART8_RX_SIZE];
uint8_t uart8_dma_tx_buffer[UART8_RX_SIZE];

uint8_t uart4_dma_rx_buffer[UART4_RX_SIZE];
uint8_t uart4_dma_tx_buffer[UART4_RX_SIZE];
